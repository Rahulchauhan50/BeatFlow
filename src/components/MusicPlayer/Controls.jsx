...
const Controls = ({SetShufflefun, data, currentIndex, totalResults, currentSongsId, activeSong,handlePlayPauseClick, repeat, setLoop, shuffle}) => (
  <div className="flex items-center justify-around md:w-36 lg:w-52 2xl:w-80">
    ...
    {!document.getElementById(currentSongsId).paused? (
